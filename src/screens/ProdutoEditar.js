...
export default function ProdutoEditar({ route }) {

  const { id, name, amount, categoryId,category } = route.params;
  ...
  async function handleSubmit() {
    setError("");
    if (!productName.trim() || !productQuantity.toString().trim()) {
    ...
    <View style={style.container}>
      ...
      <View style={style.principal}>
        ...
        <View style={style.cadastro}>
          <Text style={{color:"#FF7A04", fontSize:30, fontWeight:"bold"}}>Editar Produtos</Text>
        ...
        <View style={{ width: "100%", height: 114, alignItems: "center", justifyContent: "center" }}>
          <TouchableOpacity
            ...
            style={{marginTop:100, width: "80%", height: 50, borderRadius: 10, backgroundColor: "#EE7001", justifyContent: "center", alignItems: "center" }}>
            <Text style={{ color: "white", fontSize: 22, fontWeight: "bold" }}>Salvar</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
